	...
	static modules_init() {
		this.modules = {
			...
			Discord: this.make_module({
				...
				main_class: require("../modules/discord"),
				config: require("../modules/discord-config.json")
			}),
			Overload: this.make_module({
				name: "Overload",
				main_path: "../modules/Overload/module.js",
				main_class: require("../modules/overload"),
				config: require("../modules/overload-config.json")
			}),
			Ignore: this.make_module({
				name: "Ignore",
				main_path: "../modules/Ignore/module.js",
				main_class: require("../modules/ignore"),
				config: require("../modules/ignore-config.json")
			}),
			Holiday: this.make_module({
				name: "Holiday",
				main_path: "../modules/Holiday/module.js",
				main_class: require("../modules/holiday"),
				config: require("../modules/holiday-config.json")
			}),
			Potato: this.make_module({
				name: "Potato",
				main_path: "../modules/Potato/module.js",
				main_class: require("../modules/potato"),
				config: require("../modules/potato-config.json")
			}),
			UserJoined: this.make_module({
				name: "UserJoined",
				main_path: "../modules/UserJoined/module.js",
				main_class: require("../modules/user-joined"),
				config: require("../modules/user-joined-config.json")
			}),
			Help: this.make_module({
				name: "Help",
				main_path: "../modules/Help/module.js",
				main_class: require("../modules/help"),
				config: require("../modules/help-config.json")
			}),
			TimeToGalacon: this.make_module({
				name: "TimeToGalacon",
				main_path: "../modules/TimeToGalacon/module.js",
				main_class: require("../modules/time-to-galacon"),
				config: require("../modules/time-to-galacon-config.json")
			}),
			Boop: this.make_module({
				name: "Boop",
				main_path: "../modules/Boop/module.js",
				main_class: require("../modules/boop"),
				config: require("../modules/boop-config.json")
			}),
			Bap: this.make_module({
				name: "Bap",
				main_path: "../modules/Bap/module.js",
				main_class: require("../modules/bap"),
				config: require("../modules/bap-config.json")
			}),
			Hug: this.make_module({
				name: "Hug",
				main_path: "../modules/Hug/module.js",
				main_class: require("../modules/hug"),
				config: require("../modules/hug-config.json")
			}),
			Fanta: this.make_module({
				name: "Fanta",
				main_path: "../modules/Fanta/module.js",
				main_class: require("../modules/fanta"),
				config: require("../modules/fanta-config.json")
			}),
			Bizaam: this.make_module({
				name: "Bizaam",
				main_path: "../modules/Bizaam/module.js",
				main_class: require("../modules/bizaam"),
				config: require("../modules/bizaam-config.json")
			}),
			Assfart: this.make_module({
				name: "Assfart",
				main_path: "../modules/Assfart/module.js",
				main_class: require("../modules/assfart"),
				config: require("../modules/assfart-config.json")
			}),
			BestPony: this.make_module({
				name: "BestPony",
				main_path: "../modules/BestPony/module.js",
				main_class: require("../modules/best-pony"),
				config: require("../modules/best-pony-config.json")
			}),
			WorstPony: this.make_module({
				name: "WorstPony",
				main_path: "../modules/WorstPony/module.js",
				main_class: require("../modules/worst-pony"),
				config: require("../modules/worst-pony-config.json")
			}),
			MentionCanni: this.make_module({
				name: "MentionCanni",
				main_path: "../modules/MentionCanni/module.js",
				main_class: require("../modules/mention-canni"),
				config: require("../modules/mention-canni-config.json")
			}),
			DevCommands: this.make_module({
				name: "DevCommands",
				main_path: "../modules/DevCommands/module.js",
				main_class: require("../modules/dev-commands"),
				config: require("../modules/dev-commands-config.json")
			}),
			Solver: this.make_module({
				name: "Solver",
				main_path: "../modules/Solver/module.js",
				main_class: require("../modules/solver"),
				config: require("../modules/solver-config.json")
			}),
			GamerCanni: this.make_module({
				name: "GamerCanni",
				main_path: "../modules/GamerCanni/module.js",
				main_class: require("../modules/gamer-canni"),
				config: require("../modules/gamer-canni-config.json")
			}),
			Greetings: this.make_module({
				name: "Greetings",
				main_path: "../modules/Greetings/module.js",
				main_class: require("../modules/greetings"),
				config: require("../modules/greetings-config.json")
			}),
			Compliment: this.make_module({
				name: "Compliment",
				main_path: "../modules/Compliment/module.js",
				main_class: require("../modules/compliment"),
				config: require("../modules/compliment-config.json")
			}),
			Hype: this.make_module({
				name: "Hype",
				main_path: "../modules/Hype/module.js",
				main_class: require("../modules/hype"),
				config: require("../modules/hype-config.json")
			}),
			...
			InterBotCom: this.make_module({
				...
				main_class: require("../modules/inter-bot-com"),
				config: require("../modules/inter-bot-com-config.json")
			}),
			NoMessageProcessor: this.make_module({
				name: "NoMessageProcessor",
				main_path: "../modules/NoMessageProcessor/module.js",
				main_class: require("../modules/no-message-processor"),
				config: require("../modules/no-message-processor-config.json")
			})
		};
	}
